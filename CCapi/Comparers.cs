...
namespace Launcher {
    ...
    public class CountryComparer : CustomListComparer
    {

        public CountryComparer(int column) : base(column) { }
    ...
    public class NumericalComparer : CustomListComparer {
		...
		protected override int Compare( ListViewItem x, ListViewItem y ) {
			int valX = Int32.Parse( x.SubItems[col].Text );
			int valY = Int32.Parse( y.SubItems[col].Text );
